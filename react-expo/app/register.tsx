...
import { TouchableOpacity, KeyboardAvoidingView, Platform, Keyboard, TouchableWithoutFeedback, StyleSheet } from "react-native";
            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <Box flex={1} justifyContent="center" alignItems="center" p="$5">
                    <VStack space="md" w="90%" alignItems="flex-start">
                        ...
                        <Text size="md" color="$black">User Name</Text>
                        ...
                        <Text size="md" color="$black">Full Name</Text>
                        <Input w="100%" size="lg" rounded="$2xl">
                            <InputField
                        ...
                        <Text size="md" color="$black">Email address</Text>
                        <Input w="100%" size="lg" rounded="$2xl">
                            <InputField
                                placeholder="Email"
                        ...
                        <Text size="md" color="$black">Password</Text>
                        <Input w="100%" size="lg" rounded="$2xl">
                            <InputField
                                ...
                                style={{ paddingRight: 40 }} // space for icon
                            />
                            <TouchableOpacity
                                style={styles.icon}
